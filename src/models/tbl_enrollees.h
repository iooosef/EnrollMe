...
struct tbl_enrollees {
	...
	std::string enrll_midName;
	std::string enrll_lastName;
	std::string enrll_suffixName;
	std::string enrll_sex;
	int enrll_DoB;
	std::string enrll_PoB;
	...
	std::string enrll_zipCode;
	std::string enrll_addrLine;
	std::string enrll_mobileNumber;
	std::string enrll_telephoneNumber;
	std::string enrll_email;
	std::string grdn_firstName;
	std::string grdn_midName;
	std::string grdn_lastName;
	std::string grdn_suffixName;
	std::string grdn_sex;
	std::string grdn_relation;
	std::string grn_address;
	std::string grn_mobileNumber;
	std::string grn_telephoneNumber;
	std::string grn_email;
};